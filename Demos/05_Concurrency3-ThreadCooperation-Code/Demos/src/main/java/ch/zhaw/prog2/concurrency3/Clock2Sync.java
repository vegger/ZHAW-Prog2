...
public class Clock2Sync extends JFrame implements ActionListener {
    private volatile boolean running = false;
    Button start, stop;
    private Minute minute = null;
    private Second second = null;
    static Clock2Sync oClock = null;
    private Label secondLabel = null;
    private Label minuteLabel = null;

    public static void main(String[] args) {
        oClock = new Clock2Sync();
        oClock.setTitle("Uhrentest mit wait");
    ...
    class Tick {
        ...
        public synchronized void tick() {
            tickHappens = true;
            notifyAll(); // awake sleeping thread (consumer)
        }
    }
