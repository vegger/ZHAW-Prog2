...
public class Heart {
    ...
    public void executeDiastole() throws Valve.IllegalValveStateException, Valve.InvalidValvePositionException {
        if(State.SYSTOLE.equals(state)) throw new Valve.InvalidValvePositionException("Heart is in an invalid state!");
        for (Half half : halves) {
    ...
    public void executeSystole() throws Valve.IllegalValveStateException, Valve.InvalidValvePositionException {
        if(State.DIASTOLE.equals(state)) throw new Valve.InvalidValvePositionException("Heart is in an invalid state!");
        for (Half half : halves) {
