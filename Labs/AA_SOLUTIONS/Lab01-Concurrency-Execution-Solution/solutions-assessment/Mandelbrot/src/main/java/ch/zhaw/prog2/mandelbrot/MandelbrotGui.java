...
public class MandelbrotGui extends Application implements MandelbrotProcessorListener {
    ...
    public void start(Stage stage) {
        ...
        processorSelect.getItems().add("Use CompletionService-Processor");
        processorSelect.getItems().add("Use CompletableFuture-Processor");
    ...
    private MandelbrotProcessor getProcessor() {
        ...
        switch (processorIndex) {
            ...
            case 3: processor = new MandelbrotCompletionServiceProcessor(this, width, height); break;
            case 4: processor = new MandelbrotCompletableFutureProcessor(this, width, height); break;
